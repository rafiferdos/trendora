      ...
      <div className="w-full max-w-5xl flex flex-col md:flex-row overflow-hidden">
        ...
        >
          <div className="text-center mb-6">
            ...
            >
              Create an account to start trading items, discover amazing deals, and connect with our community of buyers and sellers.
            </motion.p>
            ...
            >
              <div className="flex flex-wrap justify-center gap-4 mt-6">
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md px-3 py-2 rounded-lg">
                  ...
                  <span className="text-white/90 text-sm">Secure Transactions</span>
                </div>
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md px-3 py-2 rounded-lg">
                  <span className="text-emerald-400">✓</span>
                  <span className="text-white/90 text-sm">Verified Sellers</span>
                </div>
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md px-3 py-2 rounded-lg">
                  <span className="text-emerald-400">✓</span>
